...
public class SpUtil {
    ...
    private static final String KEY_READER_FONT = "key_reader_font";
    ...
    private static final int DEFAULT_READER_FONT = 0;
    ...
    public static void saveReaderFont(int fontIndex) {
        SharedPreferences.Editor editor = App.getContext()
                .getSharedPreferences(NAME, Context.MODE_PRIVATE).edit();
        editor.putInt(KEY_READER_FONT, fontIndex);
        editor.apply();
    }

    public static int getReaderFont() {
        SharedPreferences sp = App.getContext()
                .getSharedPreferences(NAME, Context.MODE_PRIVATE);
        return sp.getInt(KEY_READER_FONT, DEFAULT_READER_FONT);
    }
}
